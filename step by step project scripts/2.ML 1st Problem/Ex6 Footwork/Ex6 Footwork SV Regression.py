...
Ex6 = X
Ex6['status'] = y
sns.heatmap(Ex6[['mean_response','successes%','status']].corr(),cmap='coolwarm',annot=True, linewidth=0.5)
# plt.figure(figsize = (16,5))
# sns.heatmap(Ex2.corr(),cmap='coolwarm',annot=True, linewidth=0.5)
plt.title("Ex6_Footwork", fontsize =20)
