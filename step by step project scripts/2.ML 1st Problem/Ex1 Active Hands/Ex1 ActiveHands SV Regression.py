...
Ex1 = X
Ex1['status'] = y
sns.heatmap(Ex1[['mean_response','successes%','dm_errors','status']].corr(),cmap='coolwarm',annot=True, linewidth=0.5)
plt.title("Ex1_ActiveHands", fontsize =20)
...
## Evalute model with RMSE & MSE & MAE & f1
